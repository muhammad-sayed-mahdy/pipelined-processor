...
force -freeze sim:/fetch/force_pc 0 0
run
run
...
force -freeze sim:/fetch/jz_signal 1 0
run
force -freeze sim:/fetch/zero_flag 1 0
run
force -freeze sim:/fetch/jz_signal 0 0
run
...
run
run
force -freeze sim:/fetch/force_pc 1 0
force -freeze sim:/fetch/correct_pc 00000000000000000000000000110000 0
run
force -freeze sim:/fetch/force_pc 0 0
run
force -freeze sim:/fetch/skip_instruc 1 0
run
force -freeze sim:/fetch/skip_instruc 0 0
run